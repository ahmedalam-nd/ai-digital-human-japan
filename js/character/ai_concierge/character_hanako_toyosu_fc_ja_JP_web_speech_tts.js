...
import { WebSpeechTTS } from "../../text_to_speech/web_speech_tts.js";
...
export const characterHanakoToyosuFC_ja_JP_WebSpeechTTS =
  new FunctionCallingCharacter({
    characterId: "characterHanakoToyosuFC_ja_JP_WebSpeechTTS",
    firstName: "花子 (FC & JSON DATA | WebSpeech TTS)",
    lastName: "豊洲",
    language: "日本語",
