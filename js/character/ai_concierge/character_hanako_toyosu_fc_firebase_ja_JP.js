...
} from "./foresightday_2024_functions_firebase.js";
...
var dataManager = new Foresightday2024DataManager({
  ...
  characterId: "characterHanakoToyosuFCFirebase_ja_JP",
});
...
export const characterHanakoToyosuFCFirebase_ja_JP =
  new FunctionCallingCharacter({
    characterId: "characterHanakoToyosuFCFirebase_ja_JP",
    firstName: "花子 (FC & Firebase | Google TTS)",
    lastName: "豊洲",
    language: "日本語",
