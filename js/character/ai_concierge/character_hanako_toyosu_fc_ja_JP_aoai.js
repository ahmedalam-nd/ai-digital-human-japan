...
import { AOAIFunctionCallingCharacter } from "../aoai_function_calling_character.js";
...
export const characterHanakoToyosuFC_ja_JP_aoai =
  new AOAIFunctionCallingCharacter({
    firstName: "花子 (AOAI w/ FC & JSON DATA | OpenAI TTS)",
    lastName: "豊洲",
    language: "日本語",
