...
import { avatarHanakoToyosuReal } from "../../avatar/video_avatar/avatar_hanako_toyosu_real.js";
...
var dataManager = new Foresightday2024DataManager({
  ...
  characterId: "characterHanakoToyosuRealFCFirebaseOpenAITTS_ja_JP",
});
...
export const characterHanakoToyosuRealFCFirebaseOpenAITTS_ja_JP =
  new FunctionCallingCharacter({
    characterId: "characterHanakoToyosuRealFCFirebaseOpenAITTS_ja_JP",
    firstName: "(FC & Firebase | OpenAI TTS)",
    lastName: "生成AIキャラクター",
    language: "日本語",
    avatar: avatarHanakoToyosuReal,
