...
import { GoogleTTSCircularAudioWave } from "../../text_to_speech/google_tts_circular_audio_wave.js";
import { WebSpeechSTT } from "../../speech_to_text/web_speech_stt.js";
import { apiKeys } from "../../apikeys.js";
import { circularAudioAvatarSunburst } from "../../avatar/circular_audio_avatar/circular_audio_avatar.js";
...
var dataManager = new Foresightday2024DataManager({
  ...
  characterId: "characterCircularAudioAvatarSunburstFCFirebase_ja_JP",
});
...
export const characterCircularAudioAvatarSunburstFCFirebase_ja_JP =
  new FunctionCallingCharacter({
    characterId: "characterCircularAudioAvatarSunburstFCFirebase_ja_JP",
    firstName: "(FC & Firebase | Google TTS)",
    lastName: "Circular Audio Avatar",
    language: "日本語",
    avatar: circularAudioAvatarSunburst,
    textToSpeech: new GoogleTTSCircularAudioWave({
      languageCode: "ja-JP",
      voiceName: "ja-JP-Neural2-C",
      apiKey: apiKeys.google_speech,
      circularAudioWave: circularAudioAvatarSunburst,
    }),
