...
export const characterHanakoDaikinEva_en_US_ifcheck = new EvaCharacter({
  characterId: "characterHanakoDaikinEva_en_US",
  firstName: "Hanako",
  lastName: "Daikin (w/ Eva) IFCheck",
  language: "English",
  ...
  evaInfo: {
    ...
    msgUrl:
      "https://api-americas-instance1.eva.bot/eva-broker/org/e9963bf0-788a-4e30-abc9-7de6067ed7bd/env/88ce4426-5231-4b23-b21c-606a0249aebd/bot/248b25e4-5e08-40ba-9afd-01dbb1b300b1/channel/2a9469ee-0916-472d-9a07-15ffd475ed39/v1/conversations",
    sessionCode: "",
  },
  extraContents: [
